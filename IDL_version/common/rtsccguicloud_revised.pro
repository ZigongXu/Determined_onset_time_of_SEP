...
; ------ Main prog
pro rtsccguicloud_revised,ima,imb,hdra,hdrb,$
...
wbase=widget_base(RESOURCE_NAME = 'base',title='STEREO Cloud',/column,/BASE_ALIGN_TOP,MODAL = keyword_set(modal),group_leader=groupleader);,xsize=400,ysize=800)
