...
STA_cor1_dir='/Volumes/Science_dat/work_2/'+event_num+'/STEREO_level_1.1/a/cor1'
...
t=create_gif_stereo(dir=sta_cor2_dir,telescope='STA',type='cor2',gif_name=save_dir_STA_cor2_gif,min=-12,max=-10)
t=create_gif_stereo(dir=sta_cor1_dir,telescope='STA',type='cor1',gif_name=save_dir_STA_cor1_gif,min=-12,max=-10)
t=create_gif_stereo(dir=stb_cor2_dir,telescope='STB',type='cor2',gif_name=save_dir_stb_cor2_gif,min=-12,max=-10)
t=create_gif_stereo(dir=stb_cor1_dir,telescope='STB',type='cor1',gif_name=save_dir_stb_cor1_gif,min=-12,max=-10)
;----
...
t=create_gif_soho(dir=SOHO_dir,gif_dir=soho_gif_dir,min=-12,max=-10)
end
